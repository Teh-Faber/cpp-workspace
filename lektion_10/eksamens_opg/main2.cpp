...
void test_2_1(){
    ...
    test<double>(c2.getWeight(), 2.5, "getWeight");
...
void test_2_2(){
    ...
    test<double>(pc.getWeight(), 7.3, "getWeight");
    test<int>(pc.getDaysToDelivery(), 0, "getDaysToDelivery");
    Cargo c = pc;
    test<double>(c.getWeight(), 7.3, "getWeight");
...
void test_2_4(){
    ...
    // Initialize new loading area idential to a, before packages were removed
    LoadingArea a2;
    a2.addCargo(ca);
    a2.addCargo(cb);
    a2.addCargo(cf);
